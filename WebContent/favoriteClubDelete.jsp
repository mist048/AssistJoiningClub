					...
					<div class="center-align">
						<ul class="pagination">
							<%
								...
								if (firstIndex > 0) {
							%>
							<li class="disabled"><form action="FromFavoriteClubDelete" method="post"
									name="formBefore">
							...
							%>
							<li class="<%=state%>">
								<form action="FromFavoriteClubDelete" method="post" name="formTo<%=i%>">
									<input type="hidden" name="firstIndex"
							...
							%>
							<li class="waves-effect"><form action="FromFavoriteClubDelete" method="post"
									name="formNext">
									<input type="hidden" name="firstIndex"
										value=<%=firstIndex + Constant.MAX_OF_DISPLAYS%>><a
